  ...
  return (
    ...
    >
      ...
      <div className="flex align-middle justify-center flex-col">
        <div className="m-auto p-20 text-center headingtop">
          ...
          <div className=" md:px-12 lg:w-2/4 lg:pl-5 lg:pr-10 rounded-2xl shadow-2xl ">
            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              <div className="my-2 w-1/2 lg:w-1/4 ">
                <button
                  className="bg-[#06C4C8] text-gray-100 p-3 rounded-full w-full 
              ...
              <li>
                <div className="flex pl-2 ">
                  <span className=" pt-2 pr-8">
                    <HubIcon sx={{ color: "#06C4C8", fontSize: "35px" }} />
                  </span>
                  <div className="border-l pl-8 pt-2">
                    <h6>Name</h6>
                    <span className="text-[#9f9f9f]">Karthik Rudrappa</span>
                  </div>
                </div>
              </li>
              <li>
                <div className="flex pl-2">
                  <span className="pt-4 pr-8">
                    <MapIcon sx={{ color: "#06C4C8", fontSize: "35px" }} />
                  </span>
                  <div className="border-l pl-8 pt-4">
                    <h6>Location</h6>
                    <span className="text-[#9f9f9f]">Syracuse, New York</span>
                  </div>
                </div>
              </li>
              <li>
